...
echo "    ros2 topic echo /dsc/proxemic_zone"
echo "    ros2 topic echo /cmd_vel_dsc"
echo ""
echo "  Inject a simulated human 1.0m ahead (Personal zone test):"
echo "    ros2 topic pub --once /social/humans std_msgs/msg/String \\"
echo "      'data: \"[{\\\"x\\\": 1.0, \\\"y\\\": 0.0, \\\"facing_deg\\\": 180}]\"'"
echo ""
echo "  Inject a human 2.0m ahead (Social zone test):"
echo "    ros2 topic pub --once /social/humans std_msgs/msg/String \\"
echo "      'data: \"[{\\\"x\\\": 2.0, \\\"y\\\": 0.3, \\\"facing_deg\\\": 90}]\"'"
echo ""
echo -e "${YELLOW}------------------------------------------${NC}"
echo ""
